                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach items="${listShoes}" var="o">
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><a href="deleteCart?pid=${o.id }" class="text-dark">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng tiền hàng</strong><strong>${sum } $</strong></li>
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng thanh toán</strong>
                                            <h5 class="font-weight-bold">${sumpay } $</h5>
                                        </li>
